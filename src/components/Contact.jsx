    ...
    <div name='contact' className='w-full h-screen bg-gradient-to-b from-gray-800 to-black p-4 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            <div className='pb-8'>
                ...
                <p className='py-6'>Get in touch with me for freelance projects!</p>
            </div>

            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/0152c0ff-8757-4524-9999-0283a166e40d" method='POST' className='flex flex-col w-full md:w-1/2 '>
