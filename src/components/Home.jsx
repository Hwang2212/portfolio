        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full'>
                ...
                <p className='text-gray-500 max-w-md'>
                    Loves solving problems using code. <br />
                ...
                <div> {/*Use group to to group hover */}
                    <button className='group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-purple-500 to-pink-500 cursor-pointer'>
                        Portfolio
