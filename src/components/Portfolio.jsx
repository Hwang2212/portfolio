...
import movieApp from '../assets/portfolio/FlutterMovieApp.png';
...
const Portfolio = () => {
  ...
  },
  {
    id: 5,
    src: movieApp,
    codelink: 'https://github.com/Hwang2212/flutter_movie'
    ...
    <div name="portfolio" className='bg-gradient-to-b from-black to-gray-800 w-full text-white md:h-screen'>
      <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
        <div className='pb-5'>
          ...
          <p className='py-4'>Browse through the work I've done!</p>
        </div>
        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0'>
          ...
          <div className='flex items-center justify-center'>
            ...
            <button className='w-1/2 px-6 py-2 m-4 duration-200 hover:scale-105'><a href={codelink} target="_blank" rel="noreferrer">Code</a> </button>
          </div>
        </div>
        ))}
